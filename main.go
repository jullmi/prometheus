...
var n_goroutines = prometheus.NewGauge(prometheus.GaugeOpts{
	Namespace: "packt",
	Name:      "n_goroutines",
	Help:      "Number of goroutines",
})

var n_memory = prometheus.NewGauge(prometheus.GaugeOpts{
	Namespace: "packt",
	Name:      "n_memory",
	Help:      "Memory usage",
})
...
func main() {
	...
	go func ()  {
		...
		goMem := getMetric[1].Value.Uint64()

		time.Sleep(time.Duration(r.Intn(15)) * time.Second)
		n_goroutines.Set(float64(goVal))
		n_memory.Set(float64(goMem))
	}()
